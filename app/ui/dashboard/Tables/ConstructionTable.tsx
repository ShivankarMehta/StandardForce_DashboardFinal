...
// The React component
const ConstructionTableComponent: React.FC<any> = ({ data}) => {
  ...
  return (
    ...
    <Title>Constructions & Total_Profit</Title>
        ...
        <TableBody>
          {data.map((item, index) => (
            <TableRow key={index} className="even:bg-gray-50">
              <TableCell className="px-4 py-2 text-left">{item.construction_name}</TableCell>
