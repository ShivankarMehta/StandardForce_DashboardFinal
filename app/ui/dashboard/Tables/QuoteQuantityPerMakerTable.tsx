...
// The React component
const QuoteQuantityMakerTableComponent: React.FC<any> = ({ data}) => {
        ...
        <TableBody>
          {data.map((item, index) => (
            <TableRow key={index} className="border-spacing-1 bg-gray-900 text-white">
              <TableCell className="px-4 py-2 text-left">{item.maker_name}</TableCell>
...
export default QuoteQuantityMakerTableComponent;
