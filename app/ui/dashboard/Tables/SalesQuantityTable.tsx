...
// The React component
const SalesQuantityTableComponent: React.FC<any> = ({ data }) => {
  ...
  return (
    <Card className="w-full border bg-gray-900 border-blue-700">
      <div className="mb-4">
          ...
          <TableBody>
            {filteredData.map((item, index) => (
              <TableRow key={index} className="border-spacing-1  bg-gray-900 text-white">
                ...
                <TableCell className="px-4 py-2 text-left">{item.TotalQuantity}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </TremorTable>
...
export default SalesQuantityTableComponent;
