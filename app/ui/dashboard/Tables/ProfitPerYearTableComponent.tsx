...
const ProfitPerYearTableComponent: React.FC<any> = ({ data }) => {
  ...
  return (
    <CardContent className=""> {/* Allows horizontal scrolling */}
        ...
        <TableBody>
          {data.map((item, index) => (
            ...
            >
              ...
              <TableCell className="px-4 py-2 text-left">
                ¥ {item.profit_2022.toLocaleString()}
              </TableCell>
              <TableCell className="px-4 py-2 text-left">
                ¥ {item.profit_2023.toLocaleString()}
              </TableCell>
              <TableCell className="px-4 py-2 text-left">
                ¥ {item.profit_2031.toLocaleString()}
              </TableCell>
              <TableCell className="px-4 py-2 text-left">
                ¥ {item.profit_2032.toLocaleString()}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
