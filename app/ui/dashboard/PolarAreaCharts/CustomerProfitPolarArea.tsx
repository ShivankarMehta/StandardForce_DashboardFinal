...
interface CustomerSalesComponentPolarProps {
  data: DataItem[];
}
...
const CustomerSalesComponentPolar: React.FC<CustomerSalesComponentPolarProps> = ({ data }) => {
...
export default CustomerSalesComponentPolar;
