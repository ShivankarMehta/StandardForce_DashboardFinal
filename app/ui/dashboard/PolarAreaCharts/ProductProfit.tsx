...
interface ProductProfitComponentPolarProps {
  data: DataItem[];
}
...
const ProductProfitComponentPolar: React.FC<ProductProfitComponentPolarProps> = ({ data }) => {
...
export default ProductProfitComponentPolar;
