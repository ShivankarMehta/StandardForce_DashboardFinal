...
interface MatterSalesComponentPolarProps {
  data: DataItem[];
}
...
const MatterSalesComponentPolar: React.FC<MatterSalesComponentPolarProps> = ({ data }) => {
  ...
  const labels = data.map(item => item.matter_name);
...
export default MatterSalesComponentPolar;
