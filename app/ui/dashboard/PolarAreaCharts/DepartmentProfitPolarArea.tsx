...
interface DepartmentSalesComponentPolarProps {
  data: DataItem[];
}
...
const DepartmentSalesComponentPolar: React.FC<DepartmentSalesComponentPolarProps> = ({ data }) => {
...
export default DepartmentSalesComponentPolar;
