...
interface ProductProfitComponentPieProps {
  data: DataItem[];
}
...
const ProductProfitComponentPie: React.FC<ProductProfitComponentPieProps> = ({ data }) => {
...
export default ProductProfitComponentPie;
