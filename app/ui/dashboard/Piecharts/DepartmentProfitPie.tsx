...
interface DepartmentSalesComponentPieProps {
  data: DataItem[];
}
...
const DepartmentSalesComponentPie: React.FC<DepartmentSalesComponentPieProps> = ({ data }) => {
...
export default DepartmentSalesComponentPie;
