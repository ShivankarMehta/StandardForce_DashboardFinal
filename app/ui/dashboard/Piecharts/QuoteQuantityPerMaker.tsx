...
interface ProductsPerMakerComponentPieProps {
  data: DataItem[];
}


const ProductsPerMakerComponentPie: React.FC<ProductsPerMakerComponentPieProps> = ({ data }) => {
  ...
  const labels = data.map(item => item.maker_name);
...
export default ProductsPerMakerComponentPie;
