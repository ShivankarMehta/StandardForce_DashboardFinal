...
interface ProductsPerSupplierComponentPieProps {
  data: DataItem[];
}


const ProductsPerSupplierComponentPie: React.FC<ProductsPerSupplierComponentPieProps> = ({ data }) => {
...
export default ProductsPerSupplierComponentPie;
