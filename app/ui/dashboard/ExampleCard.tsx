...
const KpiCardGrid: React.FC<KpiCardProps> = ({
  ...
  return (
    <Grid numItemsMd={2} numItemsLg={3} className="gap-6 mb-6">
      {/* Sales Card */}
      <Card className="p-4 bg-white border border-gray-200 rounded-lg shadow-md">
        <Flex alignItems="start">
          <div className="truncate">
            <Text className="text-xl font-bold text-gray-800 mb-2">Total Sales</Text>
      ...
      <Card className="p-4 bg-white border border-gray-200 rounded-lg shadow-md">
        <Flex alignItems="start">
          <div className="truncate">
            <Text className="text-xl font-bold text-gray-800 mb-2">Total Sales Quantity</Text>
      ...
      <Card className="p-4 bg-white border border-gray-200 rounded-lg shadow-md">
        <Flex alignItems="start">
          <div className="truncate">
            <Text className="text-xl font-bold text-gray-800 mb-2">Total Profit</Text>
